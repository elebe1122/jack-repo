    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                  <form method="POST" action="{{ url('/editPost', $postssss->id) }}" enctype="multipart/form-data">
                      @csrf
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-6">
                              <input id="post_title" type="text" class="form-control @error('post_title') is-invalid @enderror" name="post_title" value="{{ $postssss->post_title }}" required autocomplete="post_title" autofocus>
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-6">
                              <textarea id="post_body" rows="7" class="form-control @error('post_body') is-invalid @enderror" name="post_body" required autocomplete="post_body">{{ $postssss->post_body }}</textarea>
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-6">
                              <select id="category_id" type="category_id" class="form-control @error('category_id') is-invalid @enderror" name="category_id" required autocomplete="category_id">
                                ...
                                @if(count($categoriesddd) > 0)
                                  @foreach($categoriesddd->all() as $category)
                                  <option value="{{$category->id}}">{{$category->category}}</option>
                                  @endforeach
